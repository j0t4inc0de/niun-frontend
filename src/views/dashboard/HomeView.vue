    ...
    <div class="max-w-6xl mx-auto space-y-6 md:space-y-12 pb-12">
        ...
        <div class="relative pt-4">
            ...
            <div class="relative z-10">
                <h2 class="text-3xl md:text-5xl font-bold text-white tracking-tight drop-shadow-lg">
                ...
                <p class="text-mako-300 mt-1 md:mt-2 text-sm md:text-lg font-light tracking-wide">
                    Panel de Control <span class="mx-2 text-mako-600">|</span> Resumen
                </p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-8">
            ...
            <div
                class="col-span-2 md:col-span-1 group relative overflow-hidden rounded-[2rem] border border-white/5 bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-xl shadow-2xl transition-all duration-300 hover:-translate-y-1 hover:border-white/10 hover:shadow-primary/10">
                <div
                ...
                <div
                    ...
                    <div>
                        <p
                            ...
                            Tu Plan</p>
                        <h3 class="text-2xl md:text-3xl font-bold text-white tracking-tight">{{ auth.user?.plan?.nombre
                            || '...' }}</h3>
                    </div>

                    <div class="md:mt-8">
                        <div
                            class="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-full bg-black/20 border border-white/5 backdrop-blur-md">
                            ...
                            <span class="text-[0.65rem] md:text-xs font-bold text-white tracking-wide">
            ...
            <div
                class="col-span-1 group relative overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-br from-white/5 via-white/[0.02] to-transparent backdrop-blur-2xl shadow-2xl transition-all duration-300 hover:-translate-y-1 hover:border-white/20 hover:shadow-primary/20">
                <div
                ...
                <div class="p-5 md:p-8 h-full flex flex-col justify-between relative z-10">
                    ...
                    <div class="mt-2 md:mt-4 flex flex-col md:flex-row md:items-baseline gap-0 md:gap-1.5">
                        <span class="text-3xl md:text-5xl font-bold text-white tracking-tighter drop-shadow-lg">
                            {{ auth.user?.limites?.cuentas?.usadas || 0 }}
                        </span>
                        <div class="flex flex-col">
                            <span class="text-xs md:text-lg font-bold text-mako-300 hidden md:block">Items</span> <span
                    ...
                    <div class="mt-4 md:mt-8 space-y-2 md:space-y-3">
                        ...
                        <div class="flex justify-between items-center text-[0.65rem] md:text-xs font-medium px-1">
                            <div class="flex items-center gap-1.5 text-mako-300">
                                <span>Max: <span class="text-white font-bold">{{ auth.user?.limites?.cuentas?.total ||
                                    10 }}</span></span>
                            </div>
                        </div>
                    </div>
            ...
            <div
                ...
                <div class="p-5 md:p-8 h-full flex flex-col justify-between relative z-10">
                    ...
                    <div class="mt-2 md:mt-4 flex flex-col md:flex-row md:items-baseline gap-0 md:gap-1.5">
                        ...
                        <div class="flex flex-col">
                            <span class="text-[0.7rem] md:text-lg font-bold text-mako-300">MB</span>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 md:mt-8 space-y-2 md:space-y-3">
                        ...
                        <div class="flex justify-between items-center text-[0.65rem] md:text-xs font-medium px-1">
                            <div class="flex items-center gap-1.5 text-mako-300">
                                <span>De: <span class="text-white font-bold">{{
        ...
        <div
            ...
            <div class="relative bg-mako-950/80 backdrop-blur-2xl rounded-[2.5rem] p-6 md:p-10 overflow-hidden">
                <div
                ...
                <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
                    <div class="flex items-center gap-4 md:gap-6 text-center md:text-left">
                        <div
                            class="shrink-0 w-16 h-16 md:w-20 md:h-20 rounded-full bg-gradient-to-br from-yellow-400/20 to-orange-500/20 border border-yellow-400/30 flex items-center justify-center shadow-[0_0_30px_rgba(250,204,21,0.15)]">
                            <span
                                class="material-symbols-outlined text-3xl md:text-4xl text-yellow-400 drop-shadow-lg">emoji_events</span>
                        </div>
                        <div>
                            <h3 class="text-xl md:text-2xl font-bold text-white mb-1 md:mb-2">Recompensas Niun</h3>
                            <p class="text-mako-300 max-w-lg leading-relaxed text-sm md:text-lg">
                                Llevas <span class="text-white font-bold text-lg md:text-xl">{{
